...
public class ParticipantAsserts {
    ...
    public static void assertParticipantUpdatableRelationshipsEquals(Participant expected, Participant actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getPatcontact()).as("check patcontact").isEqualTo(actual.getPatcontact()))
            .satisfies(e -> assertThat(e.getPatenquette()).as("check patenquette").isEqualTo(actual.getPatenquette()));
    }
}
