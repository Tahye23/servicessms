...
public class QuestionAsserts {
    ...
    public static void assertQuestionUpdatableFieldsEquals(Question expected, Question actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getQusordre()).as("check qusordre").isEqualTo(actual.getQusordre()))
            .satisfies(e -> assertThat(e.getQusmessage()).as("check qusmessage").isEqualTo(actual.getQusmessage()));
    }
    ...
    public static void assertQuestionUpdatableRelationshipsEquals(Question expected, Question actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getQusenquette()).as("check qusenquette").isEqualTo(actual.getQusenquette()))
            .satisfies(e -> assertThat(e.getQustypequestion()).as("check qustypequestion").isEqualTo(actual.getQustypequestion()));
    }
}
