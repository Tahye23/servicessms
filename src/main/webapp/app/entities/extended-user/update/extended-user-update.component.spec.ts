...
describe('ExtendedUser Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ExtendedUserUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const extuser: IUser = { id: 10385 };
      extendedUser.extuser = extuser;

      const userCollection: IUser[] = [{ id: 10042 }];
      jest.spyOn(userService, 'query').mockReturnValue(of(new HttpResponse({ body: userCollection })));
      const additionalUsers = [extuser];
    ...
    it('Should update editForm', () => {
      const extendedUser: IExtendedUser = { id: 456 };
      const extuser: IUser = { id: 28560 };
      extendedUser.extuser = extuser;

      activatedRoute.data = of({ extendedUser });
      comp.ngOnInit();

      expect(comp.usersSharedCollection).toContain(extuser);
