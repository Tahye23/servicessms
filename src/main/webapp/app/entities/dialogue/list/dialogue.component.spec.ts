...
import { sampleWithRequiredData } from '../dialogue.test-samples';
...
describe('Dialogue Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, DialogueComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.dialogues?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to dialogueService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDialogueIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDialogueIdentifier).toHaveBeenCalledWith(entity);
