...
type RestOf<T extends IConversation | NewConversation> = Omit<T, 'covdatedebut' | 'covdatefin'> & {
...
export class ConversationService {
  ...
  protected convertDateFromClient<T extends IConversation | NewConversation | PartialUpdateConversation>(conversation: T): RestOf<T> {
    return {
      ...conversation,
      covdatedebut: conversation.covdatedebut?.toJSON() ?? null,
      covdatefin: conversation.covdatefin?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restConversation: RestConversation): IConversation {
    return {
      ...restConversation,
      covdatedebut: restConversation.covdatedebut ? dayjs(restConversation.covdatedebut) : undefined,
      covdatefin: restConversation.covdatefin ? dayjs(restConversation.covdatefin) : undefined,
    };
  }
