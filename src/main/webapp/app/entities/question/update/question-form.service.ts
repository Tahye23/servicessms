...
type QuestionFormGroupContent = {
  ...
  qusordre: FormControl<IQuestion['qusordre']>;
  qusmessage: FormControl<IQuestion['qusmessage']>;
  qusenquette: FormControl<IQuestion['qusenquette']>;
  qustypequestion: FormControl<IQuestion['qustypequestion']>;
};
...
export class QuestionFormService {
  createQuestionFormGroup(question: QuestionFormGroupInput = { id: null }): QuestionFormGroup {
    ...
    return new FormGroup<QuestionFormGroupContent>({
      ...
      qusordre: new FormControl(questionRawValue.qusordre),
      qusmessage: new FormControl(questionRawValue.qusmessage),
      qusenquette: new FormControl(questionRawValue.qusenquette),
      qustypequestion: new FormControl(questionRawValue.qustypequestion),
    });
  }
