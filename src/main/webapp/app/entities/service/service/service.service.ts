...
export class ServiceService {
  ...
  //updateStatus(id: number, actif: boolean): Observable<IService> {
  // return this.http.put<IService>(`${this.resourceUrl}/${id}/status?actif=${actif}`, {});
  //}

  // updateStatus(serviceService : ServiceService, statut: boolean): Observable<void> {
  // return this.http.put<void>(`${this.resourceUrl}/status?statut=${statut}`, {});
  //}

  activate(id: number): Observable<void> {
    return this.http.put<void>(
      `${this.resourceUrl}/${id}/activate`,
  ...
  deactivate(id: number): Observable<void> {
    return this.http.put<void>(`${this.resourceUrl}/${id}/deactivate`, {});
  }
}
