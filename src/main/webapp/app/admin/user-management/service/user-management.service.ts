...
export class UserManagementService {
  ...
  generateResetPasswordLink(email: string): Observable<string> {
    return this.http.post(
      'api/account/reset-password/generate-link',
      email,
      { responseType: 'text' }, // <-- IMPORTANT : dire que la réponse est du texte
    );
  }
