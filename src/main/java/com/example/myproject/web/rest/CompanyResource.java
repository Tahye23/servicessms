...
/**
 * REST controller for managing {@link com.example.myproject.domain.Company}.
 */
@RestController
    ...
    public ResponseEntity<Company> partialUpdateCompany(
        ...
        Optional<Company> result = companyRepository
            ...
            .map(existingCompany -> {
                ...
                if (company.getCamtitre() != null) {
                    existingCompany.setCamtitre(company.getCamtitre());
                }
                if (company.getCamdatecreation() != null) {
                    existingCompany.setCamdatecreation(company.getCamdatecreation());
                }
                if (company.getCamdatefin() != null) {
                    existingCompany.setCamdatefin(company.getCamdatefin());
                }
                if (company.getCamispub() != null) {
                    existingCompany.setCamispub(company.getCamispub());
                }
