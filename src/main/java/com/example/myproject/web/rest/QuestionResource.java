...
/**
 * REST controller for managing {@link com.example.myproject.domain.Question}.
 */
@RestController
    ...
    public ResponseEntity<Question> partialUpdateQuestion(
        ...
        Optional<Question> result = questionRepository
            ...
            .map(existingQuestion -> {
                if (question.getQusordre() != null) {
                    existingQuestion.setQusordre(question.getQusordre());
                }
                if (question.getQusmessage() != null) {
                    existingQuestion.setQusmessage(question.getQusmessage());
                }
