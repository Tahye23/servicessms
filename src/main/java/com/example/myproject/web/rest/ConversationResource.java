...
/**
 * REST controller for managing {@link com.example.myproject.domain.Conversation}.
 */
@RestController
...
public class ConversationResource {
    ...
    public ResponseEntity<Conversation> partialUpdateConversation(
        ...
        Optional<Conversation> result = conversationRepository
            ...
            .map(existingConversation -> {
                if (conversation.getCovdatedebut() != null) {
                    existingConversation.setCovdatedebut(conversation.getCovdatedebut());
                }
                if (conversation.getCovdatefin() != null) {
                    existingConversation.setCovdatefin(conversation.getCovdatefin());
                }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Conversation>> getAllConversations(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
